...
getAllParty().then((res)=>{this.partyList = this.partyassembleList(res.data)
...
this.props.history.push(`/invoice/${res.data.id}`);
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            ...
            <FormGroup className="col-md-10 mb-1 pl-0">
              <Form.Select name="bill.bill_by" value={values.bill.bill_by} onChange={(value)=>
                setFieldValue("bill.bill_by", value.target.value)}
          ...
          <div className="col-md-6 text-right">
            ...
            <FormGroup className="col-md-10 mb-1 pl-0 text-right">
              <Form.Select name="bill.bill_to" value={values.bill.bill_to} onChange={(value)=>
                setFieldValue("bill.bill_to", value.target.value)}
                    ...
                    <tr key={ind}>
                      ...
                      <td>
                        ...
                        <Form.Select name={`bill.billitems[${ind}].item`} value={values.bill.billitems[ind].item}
                          onChange={(value)=> {console.log(values);setFieldValue(`bill.billitems[${ind}].item`,
                          value.target.value)}}

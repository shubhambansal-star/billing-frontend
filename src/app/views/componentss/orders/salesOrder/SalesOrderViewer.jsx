...
import { getDetailedSalesOrderByID, deleteSalesOrder } from "./SalesOrderService";
...
class BrokerViewer extends Component {
  ...
  async componentDidMount() {
    ...
    getDetailedSalesOrderByID(this.props.match.params.id).then((res) => {
        ...
        <div id="print-area" className="px-3">
          <div className="row">
            <div className="col-md-6">
              <h3 className="font-weight-bold"><strong>Sales Order <span className={classList({
            ...
            <div className="col-md-6 text-right">
              <p className="text-capitalize">
                ...
                <strong>Sales Type:</strong> {this.state?.broker?.sales_type==="mandi-sales"?"Mandi Sales":"Sales"}
              </p>
              <p>
              ...
              <table className="table mb-4">
                <thead className="bg-gray-300">
                  <tr>
                    ...
                    <th scope="col">Quantity Loaded</th>
                  </tr>
                </thead>
                <tbody>

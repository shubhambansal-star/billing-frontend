...
import { getAllBroker, deleteBroker } from "./BrokerService";
...
class CompanyList extends Component {
  ...
  componentDidMount() {
    getAllBroker().then(res => this.setState({ companyList: res.data }));
  }
  ...
  handeViewClick = companyId => {
    this.props.history.push(`/orders/broker/${companyId}`);
  };
  ...
  render() {
    ...
    return (
      <Row>
            ...
            <Card elevation={6} className="invoice-details">
                <div className="row mt-4 ms-3 me-3 mb-2 justify-content-between">
                  <div className="col-md-2">
                    <h4 className="fw-bold">Broker List</h4>
                  </div>
                  <div className="col-md-2">
          ...
          <Table style={{ minWidth: 750 }}>
            <thead>
              <tr>
                ...
                <th className="px-0">Brokerage</th>
          ...
          {companyList.length===0?<h5 className="fw-bold text-danger text-center">No Broker</h5>:<></>}
          </div>
        </Card>
        </Col>
            </Row>

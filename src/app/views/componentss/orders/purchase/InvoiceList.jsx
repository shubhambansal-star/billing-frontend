...
class InvoiceList extends Component {
  ...
  orderperpage= 5
  componentDidMount() {
    getAllPurchaseOrder(this.orderperpage,this.pageNumber,this.props.purchaseType, this.props.search, this.props.start_date, this.props.end_date, this.props.pending).then(res => this.setState({ companyList: res.data.results, count:res.data.count }));
  }
...
handlePageClick = data => {
  ...
  handeViewClick = invoiceId => {
    this.props.history.push(`/orders/purchase/${invoiceId}`);
  };
      ...
      <div>
        ...
        <div className="w-100 overflow-auto">
          <Table style={{ minWidth: 750 }}>
            {this.props.purchaseType==="mandi-purchase"?<thead>
              <tr>
            ...
            <tbody>
              {companyList.map((company, index) => (
                this.props.purchaseType==="mandi-purchase"?
                <tr key={company.id}>
